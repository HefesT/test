(function ($) {
  ...
  Drupal.behaviors.radikal_fishing_theme_custom_toolbar = {
  ...
  // on normal devices.
  Drupal.behaviors.radikal_fishing_theme_custom_search_api_ranges = {
    attach:function (context, settings) {
  ...
  Drupal.behaviors.radikal_fishing_theme_custom_search = {
    attach: function(context, settings) {
      $('body').bind('responsivelayout', function(e, d) {
